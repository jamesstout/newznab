#SETUP
###This assumes that you have already setup your install using [https://github.com/itandrew/Newznab-InnoDB-Dropin.git][1] If not, please do that first.
 ...
 - Run my script.
  ...
  [1]: https://github.com/itandrew/Newznab-InnoDB-Dropin.git
